...
//=================
//Spollers old СТАРАЯ ВЕРСИЯ от bdemetrix'a, САМ ВСТАВИЛ
...
//=================
//SlideToggle //было (неработающее дерьмо)
...
} */ //было в сборке изначально, нихуя не работает
//SlidetToggle // достал из сборки bdemetrix'a
...
if (priceSlider) {
	...
	//let textFrom = priceSlider.getAttribute('data-from'); // из новой сборки, появляются левые тултипы
	//let textTo = priceSlider.getAttribute('data-to'); // из новой сборки, появляются левые тултипы

	noUiSlider.create(priceSlider, {
		start: [0, 200000],
		connect: true,
		//tooltips: [wNumb({ decimals: 0, prefix: textFrom + ' ' }), wNumb({ decimals: 0, prefix: textTo + ' ' })], // из новой сборки, появляются левые тултипы
		tooltips: [wNumb({ decimals: 0 }), wNumb({ decimals: 0 })], //из старой, всё идеально
		range: {
			'min': [0],
			'max': [200000]
		}
	...
	//========= 4 строчки ниже были закомментированы, нужны для связи инпутов и полосы
	...
	//всё что ниже - написал сам, по сути в обе стороны объединяет ползунок и инпуты
	...
	if (scr_items.length > 0) {
		for (let index = 0; index < scr_items.length; index++) {
			...
			if ((src_value > scr_item_offset - scr_item_point) && src_value < (scr_item_offset + scr_item_height)) {
				...
				//если нужно чтобы класс ._active был постоянно - просто нужно закомментировать строчку внизу
